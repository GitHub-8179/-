                  ...
                  <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="username" name="username" class="form-control"  placeholder="请输入用户名称" type="text" >
                                </div>
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="phone" name="phone" class="form-control" placeholder="请输入手机号" type="text" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">E-mail：</label>
                                <div class="col-sm-8">
                                    <input id="email" name="email" class="form-control" placeholder="请输入E-mail" type="text">
                                </div>
                            </div>
                           <!--  <div class="form-group">
...
<script type="text/javascript" src= "<%=basePath %>views/borrowcard/js/borrowcard.js"></script>
