		       ...
		       <div class="panel-heading">
		            <form role="form" id="searchForm" class="form-inline">
		                <div class="form-group">
		                    <label for="sname1">借阅用户名称:</label> 
		                    <input type="text" class="form-control" id="userName" name="userName" placeholder="请输入用户名称">
		                </div>
		                 <div class="form-group">
		                    <label for="sname1">借阅时间:</label> 
		                    <input class="form-control layer-date"  id="data" name="startTime" >
		                <div class="form-group">
		                
		                <div class="form-group">
		                    <label for="sname1">操作人用户名称:</label> 
		                    <input class="form-control layer-date"  id="adminName" name="adminName" >
		                <div class="form-group">
...
<script type="text/javascript" src= "<%=basePath %>views/borrowRecord/js/borrowRecord.js"></script>
</html>