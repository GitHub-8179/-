...
public class Test {
	...
	public static void main(String[] args) throws MessagingException, IOException
    {
        ...
        SendMail mail = new SendMail("1196332883@qq.com","kqooyzcpilydbaba");
        map.put("mail.smtp.host", "smtp.qq.com");
//        map.put("pop.qq.com", "smtp.qq.com");
        ...
        //list.add("***92@sina.cn");
        list.add("****@163.com");
        mail.setRecipient("1196332883@qq.com");
...
//      mail.setMultipart("D:你你你.txt");
        mail.setContent("谢谢合作,哈哈联通了", "text/html; charset=UTF-8");
